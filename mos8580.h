/**************************************************
	...
	dealing with something that had extended
	addressing capabilities. Could have mapped
	these to memory locations :(
...
// There are three voices, each with indentical register definitions
...
#define CONTROL		4		// Explained later.
...
#define OSC3_BYPASS 0x80	// Disconnect voice 3 from output. Reason explained later

// Outputs. Only these registers are readable.
#define ADC1		25		// Output of analog to digital converter 1 (POTX Pin)
#define ADC2		26		// Output of analog to digital converter 2 (POTY Pin)
#define OSC3		27		// Oscillator 3 output. Reads value from voice 3 oscillator
 ...
 * (noise). More examples are available from my 1987 Programmer's Reference Guide */
...
// Sadly, registers on the SID are write only
